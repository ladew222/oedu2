...
class LayoutChangeSettings extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($layout instanceof PluginFormInterface) {
      ...
      $subform_state = SubformState::createForSubform($form['layout_settings_wrapper']['layout_settings'], $form, $form_state);
      $form['layout_settings_wrapper']['layout_settings'] = $layout->buildConfigurationForm($form['layout_settings_wrapper']['layout_settings'], $subform_state);
    }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($layout instanceof PluginFormInterface) {
      $layout->submitConfigurationForm($form['layout_settings_wrapper']['layout_settings'], SubformState::createForSubform($form['layout_settings_wrapper']['layout_settings'], $form, $form_state));
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    $layout = $this->manager->createInstance($layout_id, []);
    if ($layout instanceof PluginFormInterface) {
      $layout->validateConfigurationForm($form['layout_settings_wrapper']['layout_settings'], SubformState::createForSubform($form['layout_settings_wrapper']['layout_settings'], $form, $form_state));
    }
  }
